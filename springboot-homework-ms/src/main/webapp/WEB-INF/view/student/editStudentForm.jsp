		...
		<div class="layui-col-md12 ">
			<div class="layui-row ">
				<div class="layui-col-md10 layui-col-md-offset1">
					<form class="layui-form " action="editStudent" id="stunfoForm"
						style="margin-top: 20px; padding: 5px">
						<div class="layui-row layui-bg-gray" id="mainPanle">

							<blockquote class="layui-elem-quote">修改学生信息</blockquote>
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="text" name="className" autocomplete="off"
											   required id="className" lay-verify="required" disabled=""
											   class="layui-input myForm">
									</div>
								</div>
								<div class="layui-form-item">
							...
							<input type="text" id="studentId" class="layui-input layui-hide">
