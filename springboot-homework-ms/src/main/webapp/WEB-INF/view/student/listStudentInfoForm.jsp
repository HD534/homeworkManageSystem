...
<script>
    layui.use(['table', 'form', 'layer'], function () {
        ...
        function tableReload(courseId) {
            ...
            userName_val = userName_val == null ? null : userName_val == '' ? null : userName_val;

            var userCode_val = $('#userCode').val();
            userCode_val = userCode_val == null ? null : userCode_val == '' ? null : userCode_val;
