        ...
        <div class="layui-row ">
            <div class="layui-col-md10 layui-col-md-offset1">
                <form class="layui-form " action="addHomework" id="homeworkInfoForm"
                      style="margin-top: 20px; padding: 5px" enctype="multipart/form-data">
                    <div class="layui-row layui-bg-gray" id="mainPanle">
                        ...
                        <div class="courseInfo" id="item1">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <textarea name="homeworkDesc" placeholder="请填写作业描述"
                                              class="layui-textarea myForm"></textarea>
                                    <!-- autocomplete="new-password" -->
                                </div>
                            </div>
                            <label class=" layui-input-block">作业文件 <span style="color: red">(文件类型限制：PDF,doc,压缩文件)</span></label>
                            <div class="layui-form-item" style="margin-top:5px">
                                <div class="layui-input-block">
                                    <button type="button" class="layui-btn layui-btn-normal"
                                            id="homeworkFileInput" class="myForm"><i class="layui-icon">&#xe67c;</i>选择文件
                                    </button>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">作业截至日期</label>
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input myForm" id="homeworkDueDate"
                            ...
                            <div class="layui-form-item demoTable" style="padding: 5px">
                                <div class="layui-input-block">
                                    <button class="layui-btn" id="submit" lay-submit="" lay-filter="formDemo">立即提交
                                    </button>
                                    <button type="button" class="layui-btn layui-btn-primary" data-type="cancle"
                                            lay-filter="cancle">取消
                                    </button>
                                </div>
                            </div>
