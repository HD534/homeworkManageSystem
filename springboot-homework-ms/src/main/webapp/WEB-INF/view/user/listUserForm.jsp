        ...
        <div class="buttonClick">
            <div class="layui-input-inline demoTable"
                ...
                <button type="button" class="layui-btn layui-icon"
                        data-type="addNewUser" style="margin-left: 20px; margin-right: 20px">&#xe61f; 新增人员
                </button>
                <button type="button" class="layui-btn layui-icon"
                        data-type="reload" style="margin-left: 50px">搜索 &#xe615;
                </button>
            </div>
        </div>
    </form>
        ...
        .use(
            ...
            function () {
                ...
                table.on('tool(userTable)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                    ...
                    console.log(data)
                    if (layEvent === 'del') {
                        layer.confirm('确定删除人员吗？' + '学号/工号：' + data.userCode + ' , 姓名：' + data.userName,
                            function (index) {
                        ...
                        layer.open({
                            ...
                            success: function (layero, index) {
                                ...
                                var sexSel = data.sex == '男' ? 1 : 2;
                                body.find("#sex" + sexSel + '').prop("checked", true);
                                body.find("#userName").val(data.userName);
                                body.find("#userCode").val(data.userCode);
                                body.find("#age").val(data.age);
                                body.find("#userTypeName").val(data.userTypeName);
